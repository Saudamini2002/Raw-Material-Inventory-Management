...
function resetForm()
{
    ...
    var getCurRequest = createGET_BY_RECORDRequest(connToken, dbName,relName, getCurrRecNoFromLS());
...
function changeData() {
    ...
    var updateRequest=createUPDATERecordRequest(connToken,jsonChg,dbName, relName, getCurrRecNoFromLS());
    jQuery.ajaxSetup({async:false});
...
function getFirst()
{
    var getFirstRequest=createFIRST_RECORDRequest(connToken, dbName, relName);
    jQuery.ajaxSetup({async:false});
...
function getPrev()
{
    ...
    var getPrevRequest=createPREV_RECORDRequest(connToken, dbName, relName,r);
    jQuery.ajaxSetup({async:false});
...
{
    var r=getCurrRecNoFromLS();
    var getPrevRequest=createNEXT_RECORDRequest(connToken, dbName, relName, r);
    jQuery.ajaxSetup({async:false});
...
function getLast()
{
    var getLastRequest=createLAST_RECORDRequest(connToken, dbName, relName);
    jQuery.ajaxSetup({async:false});
